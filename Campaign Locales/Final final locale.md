...
|Gifts|data_set:'{data set name}'|Attaches a Campaign Data Set as the answer option for the Gifts component|data_set:'WVA Gifts XMas' uses the Campaign Data Set 'WVA Gifts XMas' as a drop list||
